 ...
 *          method call is successfully sent, NULL otherwise; the pending
 *          call returned is referenced, the caller must unreference it after
 *          use
 */
DBusPendingCall *
 ...
 * @param message  the D-Bus signal to send
 *
 * @return         TRUE if the message was a signal, method call return or
 ...
 *
 * @param interface      the interface name of the broadcasted signal
 * @param cb             the DBusHandleMessageFunction callback for receiving
 *                       messages
