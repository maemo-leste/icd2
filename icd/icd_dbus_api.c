...
/**
 * @brief  Function for sending address info data to listeners
 *
 * @param  iap           the IAP
 * @param  foreach_data  foreach data structure
 *
...
/**
 * @brief  Handle addrinfo requests
 *
 * @param  conn       D-Bus connection
 * @param  msg        D-Bus message
...
/**
 * @brief  Free a statistics data structure
 *
...
/**
 * @brief  Function for sending statistics data to listeners
 *
 * @param  iap           the IAP
 * @param  foreach_data  foreach data structure
 *
...
/**
 * @brief  Stop iterating at the first IAP
 *
...
/**
 * @brief  Handle disconnect requests
 *
 * @param  conn       D-Bus connection
 * @param  msg        D-Bus message
 * @param  user_data  dbus client data
...
/**
 * @brief  Handle select connection requests
 *
 * @param  conn       D-Bus connection
 * @param  msg        D-Bus message
 * @param  user_data  dbus client data
...
/**
 * @brief  Append a the network type of the successfully started network scan
 *         to the iterator position
 *
...
/**
 * @brief  Start scan for each each given network module
 *
...
/**
 * @brief  Create and send an (N)ACK to a listener
 *
 * @param  status  status
...
/**
 * @brief  Send a NACK on disconnect or unsuccessful connection creation to
 *         D-Bus applications; free tracking info
 *
...
/**
 * @brief  Send an ACK on successful connection creation to D-Bus
 *         applications
 *
 * @param  tracklist  the list of tracked applications
...
/**
 * @brief  Send network type search start/stop
 *
