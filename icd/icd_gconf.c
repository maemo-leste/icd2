...
/**
 * @brief  Get a boolean value from gconf
 *
...
/**
 * @brief  Check whether the setting is temporary
 *
...
/**
 * @brief  Remove a gconf directory if it is a temporary IAP
 *
...
/**
 * @brief  Remove temporary IAPs from gconf
 *
...
/**
 * @brief  Set notification func for gconf changes
 *
