...
/**
 * @brief  Iterator function called for each active IAP structure starting
 *         from the structure associated with the newest request. Only active
 *         IAPs are iterated through, not the ones in a request that will be
 *         tried if the current one fails.
 *
