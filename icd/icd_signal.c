 ...
 *         data. This function only polls the signal pipe and calls
 *         signal_handler to do the actual work.
 *
 ...
 *         signal handler to main thread. Hook all processed signals and
 *         create a Glib io watch for the pipe.
 *
