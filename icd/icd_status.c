...
/**
 * @brief  Send the actual status changed signal
 *
...
/**
 * @brief  Send a network disconnect signal
 *
...
/**
 * @brief  Send a service provider limited network connection
...
/**
 * @brief  Send a connecting signal
 *
 * @param  network           the network to connect
 * @param  dbus_destination  D-Bus destination or NULL for broadcast
 * @param  err_str           error string or NULL if no error
...
/**
 * @brief  Send a network disconnected signal
 *
 * @param  network           the network to connect
 * @param  dbus_destination  D-Bus destination or NULL for broadcast
 * @param  err_str           error string or NULL if no error
...
/**
 * @brief  Send a scanning stop signal
 *
 * @param  network_type  network type
 */
void
...
/**
 * @brief  Send a scanning start signal
 *
 * @param  network_type  network type
 */
void
