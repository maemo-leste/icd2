...
/**
 * @brief  Set static network priority for the cahce entry
 *
...
/**
 * @brief  Check if there are more higher priority networks available. Return
 *         also the priority if the return pointer is set. This function can
 *         be called from policy modules (policy_always_online.so calls this
 *         func)
 *
 * @param  srv_type       service type or NULL if none
 * @param  srv_id         service id or NULL if none
