...
/**
 * @brief  Iterate over all requests and call the user given function for
 *         each of them
 *
...
/**
 * @brief  Send a NACK to all D-Bus listeners
 *
...
/**
 * @brief  Free an #icd_request structure
 *
 * @param  request  the request
 */
static void
...
/**
 * @brief  Notify the caller with the status of the request. The callback
 *         will not be called after #ICD_REQUEST_DISCONNECTED or
 *         #ICD_REQUEST_DENIED has been reported
 *
...
/**
 * @brief  Free memory allocated for all IAPs in a request
 *
 * @param  request  the request
 */
void
...
/**
 * @brief  Cancel a request. The request will be freed when the
...
/**
 * @brief  Add tracking info to a request
 *
 * @param  request  the request
...
/**
 * @brief  Request a connection. ICd policy will be consulted and any number
 *         of IAPs may be created in response.
 *
 * @param  policy_attrs   ICD_POLICY_ATTRIBUTE_* attributes
 ...
 * @param  network_id     network id uniquely identifies the connection to
 *                        the network module in question
 *
...
/**
 * @brief  Find out whether the request already exists in the icd context
 *         request list
 *
...
/**
 * @brief  Check policy and try to connect IAP
 *
 * @param  request  the request
 *
 * @return TRUE if connection is being tried; FALSE when there are no more
 *         IAPs to try
 */
static gboolean
...
/**
 * @brief  Try to connect the request (for the first time), request UI dialog
 *         if unsuccessful
 *
...
/**
 * @brief  Make a request for a new network connection.
 *
...
/**
 * @brief  Free all tracking info associated with a request
 *
 * @param  request  the request
 */
static void
...
/**
 * @brief  Add a network connection to try.
 *
...
/**
 * @brief  Send an ACK to all D-Bus listeners
 *
...
/**
 * @brief  Find a request to change to
 *
 * @param  request    the request
...
/**
 * @brief  Callback for requesting retry UI dialog
 *
...
/**
 * @brief  IAP creation callback. Adds the IAP to the iap context list on
 *         success, frees the IAP and tries with a next one if the IAP
 *         failed.
 *
...
/**
 * @brief  Find a request by IAP id
 *
 * @param  iap_id    IAP id
...
/**
 * @brief  Remove tracking info to a request
 *
 * @param  request  the request
 * @param  track    tracking info
 */
