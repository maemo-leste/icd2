...
/**
 * @brief  Helper function for fetching the IAP type from gconf
 *
...
/**
 * @brief  IAP activation via connectivity libraries.
 *
...
/**
 * @brief  Desktop background killing application
 *
 * @param  method_call  the D-Bus request message
 * @param  user_data    user data
 *
...
/**
 * @brief  Report state for all connections
 *
...
/**
 * @brief  Get state for all connections
 *
 * @param  method_call  the D-Bus request message
 * @param  user_data    user data
 *
...
/**
 * @brief  Find the first connected request which has an iap that can give us
...
/**
 * @brief  Send connection statistics error
 *
...
/**
 * @brief  Receive IP address configuration information based on network
 *         type, attributes and id.
 *
...
/**
 * @brief  Get IPv4 address info for the latest connection
 *
 * @param  method_call  the D-Bus request message
 * @param  user_data    user data
 *
...
/**
 * @brief  Disconnection requested by application
 *
 * @param  method_call  the D-Bus request message
 * @param  user_data    user data
 *
...
/**
 * @brief  IAP activation requested by the 'Select connection' UI dialog or
 *         Connection Manager, i.e. a connection request from connectivity
 *         components without any reference counting
 *
 * @param  method_call  the D-Bus request message
 * @param  user_data    user data
 *
...
/**
 * @brief  Generic pending call callback that prints out whether the UI D-Bus
...
/**
 * @brief  Connection disconnection requested by Connectivity UIs; request
...
/**
 * @brief  Find the first connected request that has an iap which can return
 *         statistics
 *
 * @param  request    request to examine
...
/**
 * @brief  Receive ip statistics based on network type, attributes and id.
...
/**
 * @brief  Receive link post up statistics based on network type, attributes
 *         and id. Values are set to zero or NULL if statistics are not
 ...
 *                                   of network
 * @param  rx_bytes                  bytes received on the link, if
 *                                   applicable
 * @param  tx_bytes                  bytes sent on the link, if applicable
...
/**
 * @brief  Receive link statistics based on network type, attributes and id.
 *         Values are set to zero or NULL if statistics are not available or
 *         applicable
 *
...
/**
 * @brief  Get connection statistics info for the latest connection
 *
 * @param  method_call  the D-Bus request message
 * @param  user_data    user data
 *
...
/**
 * @brief  Disconnect received from UI; disconnect the last request as this
 *         way we can cancel a new connecting connection
 *
...
/**
 * @brief  Save connection received from the UI
 *
 * @param  signal     the D-Bus request message
 * @param  user_data  not used
 *
...
/**
 * @brief  Retry signal received from UI
 *
 * @param  signal     the D-Bus request message
 * @param  user_data  not used
 *
...
/**
 * @brief  Search a handler function for given D-BUS message.
 *
...
/**
 * @brief  Callback function for OSSO IC API requests
 *
...
/**
 * @brief  Initialize the OSSO IC API
 *
...
/**
 * @brief  Deinitialize OSSO IC API
 *
 * @param  icd_ctx  icd context
 */
void
...
/**
 * @brief  Cancel save dialog pending call
 *
...
/**
 * @brief  Send nacks for connect and disconnect requests; free tracking info
 *
...
/**
 * @brief  Request UI to show a retry dialog
 *
...
/**
 * @brief  Send acks for connect and disconnect requests
 *
 * @param  tracking_list  list of applications to track
...
/**
 * @brief  Request the UI to show a save dialog
 *
